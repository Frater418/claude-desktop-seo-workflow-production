...
import { integrationModeLabel, stepStatusLabel } from "../api/statusLabels"
...
export function WorkflowWorkspace({ data }: { readonly data: OperatorWorkspaceData }): JSX.Element {
  ...
  const status = step === null ? "Aktueller Schritt nicht verfuegbar" : stepStatusLabel(step.status)

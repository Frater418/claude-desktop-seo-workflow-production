...
export function ArtifactWorkspace({ api, data }: { readonly api: ArtifactRevisionApi; readonly data: ArtifactRevisionData }): JSX.Element {
  ...
  return <section className="artifact-layout">
    <section className="work-panel">
      ...
      <label>Artefaktinhalt bearbeiten<textarea aria-label="Artefaktinhalt bearbeiten" value={revision.content} onChange={(event) => revision.setContent(event.currentTarget.value)} disabled={revision.isEditingLocked} /></label>

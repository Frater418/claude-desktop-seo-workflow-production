...
class HeartwebCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        self.drawString(108, 804, "|   SEO-Workflow Modernisierung & Notion-Bridge")
...
def build_pdf_natural_flow(filename):
    ...
    meta_html = (
        "<b>Empfaenger:</b> Jesse Jensen (Heartweb) &nbsp;|&nbsp; "
        "<b>Autor:</b> Raphael Rechberger &nbsp;|&nbsp; "
        "<b>Datum:</b> 16. August 2026<br/>"
        "<b>Status:</b> Vollstaendig implementiert & auf GitHub veroeffentlicht &nbsp;|&nbsp; "
        "<b>Repo:</b> https://github.com/Frater418/claude-desktop-seo-workflow-production"
    )

...
| `superseded_alias` | [`prompts/0-kickoff.xml.md`](../prompts/0-kickoff.xml.md) | `1.8.0` | `superseded` | `e9d4619897808b05495c555d75f62819731582aa5bae9f2357f0d0573e7c375c` |
| `historical_version` | [`prompts/1-pillar-identifikation-v2.1.0.xml.md`](../prompts/1-pillar-identifikation-v2.1.0.xml.md) | `2.1.0` | `superseded` | `a7312773dbdd80787f38b603ee9ed234cf3bb8d0d86b90e5822fa24680ce80bb` |
| `active_registry` | [`prompts/1-pillar-identifikation.xml.md`](../prompts/1-pillar-identifikation.xml.md) | `2.2.0` | `current_authority` | `3658bed19f033ad8a135f633dcaeb97c9b6094a5b5d448b879c83ff25edd723c` |
...
| `1` | `heartweb.step.1@2.2.0` | [`prompts/1-pillar-identifikation.xml.md`](../prompts/1-pillar-identifikation.xml.md) `3658bed19f033ad8a135f633dcaeb97c9b6094a5b5d448b879c83ff25edd723c` | `https://heartweb.example/schema/outputs/step-1-topic-inventory.schema.json@2.0.0`: `standards/outputs/step-1-topic-inventory.schema.json` `3efe1839ecdb511db63410480c58a78daae655206464efbac39bc9d9dbd35ec1` |
...
| 162 | [`00_admin/audits/2026-08-22-m07-diagnostic-trace/SECTION_11_REPORT.md`](../00_admin/audits/2026-08-22-m07-diagnostic-trace/SECTION_11_REPORT.md) | `evidence` | 10 | `audit_evidence` | Change ID: M07-DIAGNOSTIC-TRACE-001 | `f49d929305418830de9233022f653bb24947681ca58ed1b2aabc01b0e7f18824` |
...
| 184 | [`00_admin/audits/2026-08-26-repository-consolidation/PROMPT_VERSION_RECONCILIATION.md`](../00_admin/audits/2026-08-26-repository-consolidation/PROMPT_VERSION_RECONCILIATION.md) | `evidence` | 10 | `audit_evidence` | Author: Raphael Rechberger | `cb486c75a0be63d0f80193fae44206b83adfd46ad778e21567379a2350852ce6` |
...
| 187 | [`00_admin/meetings/2026-08-17-meeting-raphael-jesse.md`](../00_admin/meetings/2026-08-17-meeting-raphael-jesse.md) | `evidence` | 20 | `meeting_source` | Datum: 17. August 2026 | `3b1f482854823357fdaf39f5916c4e4fb8c48b3003923bd7c84885d0a111c8c2` |
...
| 189 | [`03_research/exa_geo_research_raw.json`](../03_research/exa_geo_research_raw.json) | `evidence` | 20 | `research_source` | "Google AI Overviews 2026 Ranking & Passage Factors": [ | `0b2313c334e9cc29f6d2f24191171bd6fc3987ff02411b14bd04cc9d006a3f2b` |
| 190 | [`03_research/provider-strategy-2026-08-18/exa_raw.json`](../03_research/provider-strategy-2026-08-18/exa_raw.json) | `evidence` | 20 | `research_source` | "provider": "exa", | `700cc02a1945adf3dcc59cba8b642a7a2682dee65c2cc8f9c8f6f82e438871ab` |
| 191 | [`03_research/provider-strategy-2026-08-18/firecrawl_raw.json`](../03_research/provider-strategy-2026-08-18/firecrawl_raw.json) | `evidence` | 20 | `research_source` | "retrievedatutc": "2026-08-18T21:24:13.379543+00:00", | `591a312f3a46b9362f862554befe042a5135e09b4d529b0e0a5645d1fd526ec9` |
...
| 217 | [`prompts/0-kickoff.xml.md`](../prompts/0-kickoff.xml.md) | `superseded` | 20 | `prompt_contract` | Superseded unversioned Step-0 compatibility source retained for exact historical replay. | `e9d4619897808b05495c555d75f62819731582aa5bae9f2357f0d0573e7c375c` |
| 218 | [`prompts/1-pillar-identifikation-v2.1.0.xml.md`](../prompts/1-pillar-identifikation-v2.1.0.xml.md) | `superseded` | 22 | `prompt_contract` | Immutable Step-1 predecessor retained before the logical Step-0 lineage correction. | `a7312773dbdd80787f38b603ee9ed234cf3bb8d0d86b90e5822fa24680ce80bb` |
| 219 | [`prompts/1-pillar-identifikation.xml.md`](../prompts/1-pillar-identifikation.xml.md) | `current_authority` | 82 | `prompt_contract` | Active registry-bound Step-1 prompt with released Step-0 lineage, crawl and SERP Evidence operations. | `3658bed19f033ad8a135f633dcaeb97c9b6094a5b5d448b879c83ff25edd723c` |
...
| 231 | [`standards/dateinamen-und-output-vertrag.md`](../standards/dateinamen-und-output-vertrag.md) | `current_authority` | 85 | `standard_or_contract` | Projekt: Modernisierung des Claude Desktop SEO-Workflows | `0427df37955abc10b7c85ae130d1bca956b5ea80add779899b9ae98f6d7360fd` |
...
| 237 | [`standards/design-system.css`](../standards/design-system.css) | `current_authority` | 85 | `standard_or_contract` | / | `ba375b132a20521f0990c6631471d6e5634e6520966129ae1c2dfb0410c079f5` |
...
| 261 | [`standards/location-codes.json`](../standards/location-codes.json) | `current_authority` | 85 | `standard_or_contract` | "$schema": "https://json-schema.org/draft/2020-12/schema", | `84b61c7e764c4d29672a74936213ac8392b6fa7c8505c09226a46d4b8bd800bc` |
...
| 263 | [`standards/manifest.schema.json`](../standards/manifest.schema.json) | `current_authority` | 85 | `standard_or_contract` | "$schema": "https://json-schema.org/draft/2020-12/schema", | `5b47fdb13300c059d9701568171936e4903e2cdb591e803da0c1d5fd2f0871c1` |
...
| 302 | [`standards/runtime/official-prompt-registry.json`](../standards/runtime/official-prompt-registry.json) | `current_authority` | 85 | `standard_or_contract` | "entries": [ | `e3e22184f6a1a0ec32c194d43245f5dc6bc59567b3266159180042a8b15f5f8c` |
...
| 333 | [`tests/acceptance-tests.md`](../tests/acceptance-tests.md) | `evidence` | 30 | `test_evidence` | Projekt: Heartweb Claude Desktop SEO & GEO Workflow Framework | `aa4a040ac7da4865e4819b5c1145efbeb9ca297d39cea7c59370b532e2e8888d` |

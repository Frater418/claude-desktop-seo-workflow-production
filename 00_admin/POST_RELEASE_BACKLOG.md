...
| PR-006 | Full docs-corpus classification and historical PDF regeneration | DIB-002 and DIB-003 | After first release, before public repository handoff | Current state, decision, audit and operating files are enough for controlled local production. |
